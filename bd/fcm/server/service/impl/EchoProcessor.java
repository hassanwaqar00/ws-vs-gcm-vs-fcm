package it.polito.ws_vs_gcm_fcm.bd.fcm.server.service.impl;

import it.polito.ws_vs_gcm_fcm.bd.fcm.server.EntryPoint;
import it.polito.ws_vs_gcm_fcm.bd.fcm.server.bean.CcsInMessage;
import it.polito.ws_vs_gcm_fcm.bd.fcm.server.bean.CcsOutMessage;
import it.polito.ws_vs_gcm_fcm.bd.fcm.server.server.CcsClient;
import it.polito.ws_vs_gcm_fcm.bd.fcm.server.server.MessageHelper;
...
public class EchoProcessor implements PayloadProcessor {
    ...
    String LOG_FILE_NAME = "D:/server-BD.csv";
