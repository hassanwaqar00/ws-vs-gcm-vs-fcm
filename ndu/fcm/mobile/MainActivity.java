...
public class MainActivity extends AppCompatActivity {
    ...
    private class AsyncTaskSend extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                String packet = generateRandomString(64 - BYTES_MSG_ID);
                new Thread(new MyThread(packet)).start();
                Thread.sleep(500);
                packet = generateRandomString(256 - BYTES_MSG_ID);
                new Thread(new MyThread(packet)).start();
                Thread.sleep(500);
                packet = generateRandomString(1024 - BYTES_MSG_ID);
                new Thread(new MyThread(packet)).start();
                Thread.sleep(500);
                packet = generateRandomString(4055 - BYTES_MSG_ID);
                new Thread(new MyThread(packet)).start();
                Thread.sleep(500);
