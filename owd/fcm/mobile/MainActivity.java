package it.polito.ws_vs_gcm_fcm.owd.fcm.mobile;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static int BYTES_PAYLOAD = 64; // PUT SIZE OF PAYLOAD IN BYTES HERE
    public static final int BYTES_MSG_ID = 20;
    public static final int BYTES_PACKET = BYTES_PAYLOAD - BYTES_MSG_ID;
    public static final String LOG_FILE_PATH_ROOT = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/FCM";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (refreshedToken != null) Log.d(TAG, refreshedToken);
    ...
    public static void queryServerClockOffset() {
        ...
        fm.send(new RemoteMessage.Builder(SENDER_ID + "@gcm.googleapis.com")
                .setMessageId(String.valueOf(new Random().nextInt()))
                .addData("action", "it.polito.ws_vs_gcm_fcm.owd.fcm.server.CLOCK_SYNC")
                .build());
    }
