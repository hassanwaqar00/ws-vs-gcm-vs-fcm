...
import static it.polito.ws_vs_gcm_fcm.rtt.fcm.mobile.MainActivity.BYTES_MSG_ID;
import static it.polito.ws_vs_gcm_fcm.rtt.fcm.mobile.MainActivity.BYTES_PAYLOAD;
import static it.polito.ws_vs_gcm_fcm.rtt.fcm.mobile.MainActivity.LOCAL_CLOCK_OFFSET;
import static it.polito.ws_vs_gcm_fcm.rtt.fcm.mobile.MainActivity.LOG_FILE_PATH_ROOT;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            if (action != null && action.equals("it.polito.ws_vs_gcm_fcm.rtt.fcm.server.CLOCK_SYNC")) {
