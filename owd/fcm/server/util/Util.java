package it.polito.ws_vs_gcm_fcm.owd.fcm.server.util;
...
public class Util {
    ...
    public static final String PACKAGE = "it.polito.ws_vs_gcm_fcm.owd.fcm.server";
    ...
    public static final String BACKEND_ACTION_CLOCK_SYNC = PACKAGE + ".CLOCK_SYNC";
