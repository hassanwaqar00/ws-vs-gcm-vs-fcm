package it.polito.ws_vs_gcm_fcm.rtt.fcm.server.service;
 ...
 * what the action is about. An example is the action it.polito.ws_vs_gcm_fcm.rtt.fcm.server.MESSAGE, used
