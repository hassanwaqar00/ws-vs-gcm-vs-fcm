package it.polito.ws_vs_gcm.rtt.soap.mobile;			
	   ...
	   public void run() {
		   try {
			...
			try {
					...
					Log.d("SENT TIME","SN: "+i+" Time(rtt): "+now);
			} catch (IOException e) {
					e.printStackTrace();
			...
			if(envelope.bodyIn!=null) {
			    ...
			    setMSG("PAYLOAD: "+resp, 2);
			    Log.d("RECEIVED TIME","PAYLOAD LENGTH: "+resp.length()+" ,Time: "+now_received);
			}
		} catch (Exception e) {
			e.printStackTrace();
		  }
